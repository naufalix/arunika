  ...
  <div class="container p-4">
    <div class="row pt-5">
      <div class="col-12 col-md-6 my-auto py-5">
        ...
        <a class="btn btn-primary shadow-0 rounded-4" href="#maps" >Mulai Eksplorasi <i class="fa fa-sign-out ms-2"></i></a>
      </div>
      <div class="col-12 col-md-6 d-flex">
        <div class="mx-auto">
          <img src="/assets/img/hero-img.webp" alt="" style="max-width: 100%;max-height: 500px;">
        </div>
      </div>
    </div>
  </div>
